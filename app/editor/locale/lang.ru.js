...
svgEditor.readLang({
	...
	ui: {
		"toggle_stroke_tools": "Показать/скрыть дополнительные инструменты обводки",
	...
	tools: { 
		...
		"align_to_page": "Выровнять элемент к странице",
		...
		"mode_line": "Линия",
		"mode_connect": "Соединить два объекта",
		...
		"mode_zoom": "Лупа",
		"mode_eyedropper": "Инструмент «Пипетка»",
