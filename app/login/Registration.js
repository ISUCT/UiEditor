 ...
 * @module Registration
 */
define('Registration', ['forms', 'ui', 'invoke', 'UserInformation'],
        function (Forms, Ui, Invoke, UserInformation, ModuleName) {
            return function () {
                var self = this
                        , form = Forms.loadForm(ModuleName);

                var userInfo = new UserInformation();
                userInfo.showOnPanel(form.pnlProfile);
...
//        };
                ...
                function validatePwd() {
                    ...
                    if (pwdOne == pwdRepeat) {
                        if (pwdOne.length > 0) {
                            form.pwdOne.background = null;
                            form.pwdRepeat.background = null;
                            return true;
                        } else {
                            form.pwdOne.background = Ui.Color.PINK;
                            form.pwdRepeat.background = Ui.Color.PINK;
